...
function Library:Window(Title)
    ...
    Logo.ImageColor3 = Color3.fromRGB(17, 85, 232)
    ...
    MinimizedIcon.BackgroundColor3 = Color3.fromRGB(17, 85, 232)
    ...
    GameName.TextColor3 = Color3.fromRGB(17, 85, 232)
    ...
    function TabFunctions:Tab(TabTitle)
        ...
        TabButton.BackgroundColor3 = Color3.fromRGB(17, 85, 232)
        ...
        function Elements:Button(Text, Callback)
            ...
            Button.Name = "Button"
            Button.Parent = Page
            Button.BackgroundColor3 = Color3.fromRGB(10, 49, 134)
        ...
        function Elements:Slider(Text, Min, Max, Default, Increment, Callback)
            ...
            SliderDrag.BackgroundColor3 = Color3.fromRGB(14, 69, 188)
            ...
            SliderClick.TouchTap:Connect(function(Position)
                if not SliderDragging then
                    ValueChangedDuringDrag = false
                    local finalValue = UpdateSlider(math.clamp(
                        (Position.X - SliderClick.AbsolutePosition.X) / SliderClick.AbsoluteSize.X,
                        0,
                        1
                    ))
            ...
            SliderTouchArea.InputBegan:Connect(function(Input)
                if Input.UserInputType == Enum.UserInputType.Touch and not SliderDragging then
                    ValueChangedDuringDrag = false
                    ...
                    if touchPos.X >= sliderAbsPos.X and touchPos.X <= sliderAbsPos.X + sliderAbsSize.X and
                       touchPos.Y >= sliderAbsPos.Y - 15 and touchPos.Y <= sliderAbsPos.Y + sliderAbsSize.Y + 15 then
                        local finalValue = UpdateSlider(math.clamp(
                            (touchPos.X - sliderAbsPos.X) / sliderAbsSize.X,
                            0,
                            1
                        ))
            ...
            local function RefreshOptions(NewOptions)
                ...
                if #NewOptions == 0 then
                    ...
                    for _, Option in ipairs(NewOptions) do
                        ...
                        OptionButton.BackgroundColor3 = Color3.fromRGB(10, 49, 134)
